...
export  async function addProductToCart(productId,setAddToCartLoading){
  ...
  export async function getCart(setIsLoading,setCartId,setCartData,setNumOfCartItems) {
      setIsLoading(true);
    ...
    export   async function removeCartItem(productId,setCartId,setCartData,setNumOfCartItems,setIsLoading) {
  ...
  export async function removeWishListItem(productId,setIsLoadingWish,setWishlistData,refetch){
